...
**Живого демо немає, і це свідомо.** Планувався безкоштовний Hugging Face Space,
але HF відтоді закрив безкоштовний тір для Docker- і Gradio-Spaces — лишились
тільки static. Тримати ж цей сервіс на платному хостингу заради демо, яке
відкриють двічі, сенсу немає: головний артефакт проекту — таблиці в
[`output/`](output/), а не веб-інтерфейс. `docker run` вище піднімає його
локально за одну команду.
